...
hi ErrorMsg gui=none guifg=#f8f8f8 guibg=#770000
" 	VertSplit	the column separating vertically split windows
hi! link VertSplit StatusLine
" 	Folded		line used for closed folds
hi Folded term=bold
hi Folded cterm=bold ctermfg=fg ctermbg=bg
hi Folded gui=bold guifg=#f8f8f8 guibg=grey30
" 	FoldColumn	'foldcolumn'
hi FoldColumn gui=bold guifg=tan guibg=grey30
...
hi NonText gui=none guifg=SkyBlue guibg=grey30
...
hi Search gui=none guifg=#f8f8f8 guibg=#0066CC
...
hi SpecialKey gui=none guifg=yellowgreen guibg=bg
" 	StatusLine	status line of current window
hi StatusLine term=bold,inverse
hi StatusLine cterm=none ctermfg=Yellow ctermbg=Black
hi StatusLine gui=none guifg=#f0DD00 guibg=Black
...
hi TabLine gui=none guifg=#f0DD00 guibg=#777777
...
hi WildMenu gui=none guifg=bg guibg=#f0DD00
...
hi Comment gui=none guifg=#04c0f0 guibg=bg
hi cCommentL gui=none guifg=SkyBlue guibg=bg
...
hi Constant gui=none guifg=#f0dd00 guibg=bg
...
hi Identifier gui=none guifg=palegreen guibg=bg
...
hi Statement gui=none guifg=#f0DD00 guibg=bg
...
hi PreProc gui=none guifg=#e000ff guibg=bg
...
" 	 Typedef	A typedef
hi Type term=none
hi Type cterm=none ctermfg=green ctermbg=bg
hi Type gui=bold guifg=#05bf0a guibg=bg
...
hi Special cterm=none ctermfg=Magenta ctermbg=bg
hi Special gui=none guifg=#e000ff guibg=bg
...
hi Underlined gui=underline guifg=#f8f8f8 guibg=bg
" 	*Ignore		left blank, hidden
" hi Ignore term=?
hi Ignore cterm=none ctermfg=DarkGrey ctermbg=bg
hi Ignore gui=none guifg=#777777 guibg=bg
...
"hi Todo cterm=none ctermfg=orangered ctermbg=#f0DD00
hi Todo gui=none guifg=orangered guibg=#f0DD00
